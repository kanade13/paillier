...
class EncodedNumber(object):
    ...
    @classmethod
    def encode(cls, public_key, scalar, precision=None, max_exponent=None):#将整数和浮点数编码为适用于Paillier加密的格式
    ...
    def decode(self):#解码经过paillier加密的数值,返回整数或浮点数
    ...
    def decrease_exponent_to(self, new_exp):#通过乘以base减小编码数的指数,用于调整精度和隐藏数字的信息
